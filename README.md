...
3. Enter a funding-related query.  
4. Submit query → receive **instant AI-generated or static answers**.  
5. Explore insights via **insight cards** and source references.  
